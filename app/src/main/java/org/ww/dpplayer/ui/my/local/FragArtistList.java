...
import org.ww.dpplayer.ui.adapter.ArtistListAdapter;
...
public class FragArtistList extends Fragment implements SwipeRefreshLayout.OnRefreshListener, ArtistListAdapter.OnItemClickListener, SidebarView.OnLetterClickedListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        musicViewModel.getLocalMusicList().observe(getViewLifecycleOwner(), new Observer<List<Music>>() {
            ...
            public void onChanged(List<Music> musicList) {
                // 设置适配器
                adapter = new ArtistListAdapter(requireContext(), musicList);
