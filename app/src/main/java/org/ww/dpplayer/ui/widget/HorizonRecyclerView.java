...
public class HorizonRecyclerView extends RecyclerView
{
    ...
    public HorizonRecyclerView(@NonNull Context context) {
        super(context);
    }

    public HorizonRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizonRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
